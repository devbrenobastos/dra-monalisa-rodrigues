        ...
        <div className={styles.navContactRow}>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactText}>
              <p style={{ display: 'flex', alignItems: 'center', gap: '6px', margin: '0 0 8px 0' }}>
                <Phone size={14} style={{ opacity: 0.8 }} /> (19) 99999-9999
              </p>
              <p style={{ display: 'flex', alignItems: 'center', gap: '6px', margin: '0 0 8px 0' }}>
                <Mail size={14} style={{ opacity: 0.8 }} /> contato@dramonalisa.com.br
              </p>
              <p style={{ display: 'flex', alignItems: 'center', gap: '6px', margin: '0 0 8px 0' }}>
                <MapPin size={14} style={{ opacity: 0.8 }} /> Atendimento em Vinhedo e região de Campinas
              </p>
              <p style={{ display: 'flex', alignItems: 'center', gap: '6px', margin: '8px 0 0 0', opacity: 0.8, fontSize: '0.875rem' }}>
